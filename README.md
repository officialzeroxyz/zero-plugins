...
plugins/zero-cursor/              # thin Cursor overlay (skill + MCP + session hook)
scripts/build-cursor.sh           # assembles the Cursor project template into dist/
...
it ships the **Claude Code**, **Codex**, **Cursor**, **Droid**, and
